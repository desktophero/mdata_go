...
var testPayloads = []struct {
	...
	{nil, *MdPayload{}, &processor.InvalidTransactionError{Msg: "Must contain payload"}},
	...
	{[]byte("create,00012345600012"), *MdPayload{}, &processor.InvalidTransactionError{Msg: "Mtrl is required for create and update"}},
